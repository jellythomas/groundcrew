...
server.setRequestHandler(ListToolsRequestSchema, async () => ({
  tools: [
    ...
    },
    {
      name: "session_info",
      description:
        "Get the current Groundcrew session info. Call this when activating groundcrew " +
        "to display the session ID to the user. Always call this first before any other " +
        "groundcrew tool so the user knows which session they're on.",
      inputSchema: {
        type: "object" as const,
        properties: {},
      },
